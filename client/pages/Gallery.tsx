        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-600 mb-8">
              We're currently organizing our collection of student work,
              workshop photos, and success stories. This page will showcase the
              amazing projects and achievements of our Ayush Foundation
              community.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  3D printed creations, marketing campaigns, and innovative
                  solutions
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Behind-the-scenes footage of our hands-on learning sessions
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Testimonials and achievements from our amazing students
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <p className="text-gray-600 mb-6">
              Want to be featured in our gallery? Share your projects and
